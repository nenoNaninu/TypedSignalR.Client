...
namespace TypedSignalR.Client
{
    ...
    public partial class ClientBaseTemplate : ClientBaseTemplateBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(", System.IAsyncDisposable\r\n    {\r\n        protected class HubInvoker : ");
            this.Write(this.ToStringHelper.ToStringWithCulture(HubInterfaceName));
...
");
 foreach(var method in ClientMethods) { 
            ...
            this.Write("        }\r\n\r\n");
 foreach(var method in ClientMethods) { 
            this.Write("        public abstract System.Threading.Tasks.Task ");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.MethodName));
            this.Write("(");
            this.Write(this.ToStringHelper.ToStringWithCulture(method.ArgParameterToString()));
            this.Write(");\r\n\r\n");
 } 
            this.Write(@"        public virtual System.Threading.Tasks.Task OnClosed(System.Exception e) => System.Threading.Tasks.Task.CompletedTask;
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class ClientBaseTemplateBase
    {
        #region Fields
