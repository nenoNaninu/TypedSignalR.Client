...
namespace TypedSignalR.Client.T4
{
    ...
    public partial class ExtensionsInternalTemplate : ExtensionsInternalTemplateBase
    {
        /// <summary>
 ...
 foreach(var invoker in InvokerList) {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(invoker.CollisionFreeName));
            this.Write(" : ");
 ...
 foreach(var receiver in ReceiverList){ 
            ...
            this.Write(" receiver)\r\n        {\r\n            var compositeDisposable = new CompositeDisposa" +
                    "ble(");
            this.Write(this.ToStringHelper.ToStringWithCulture(receiver.ClientMethods.Count + 1));
            this.Write(");\r\n");
 ...
 foreach(var receiver in ReceiverList){ 
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class ExtensionsInternalTemplateBase
    {
        #region Fields
