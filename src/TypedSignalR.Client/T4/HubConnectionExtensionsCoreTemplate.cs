...
namespace TypedSignalR.Client.T4
{
 ...
 foreach(var hubProxyType in HubProxyTypeList) {
            this.Write("        private class HubInvokerFor");
 ...
 foreach(var method in hubProxyType.Methods) { 
            ...
            this.Write(")\r\n            {\r\n                return Microsoft.AspNetCore.SignalR.Client.HubC" +
                    "onnectionExtensions.InvokeCoreAsync");
 ...
 foreach(var method in receiverType.Methods) { 
            ...
            this.Write("        static HubConnectionExtensions()\r\n        {\r\n");
 foreach(var hubProxyType in HubProxyTypeList) {
